...
export class ListaTareasComponent {
 ...
 // constructor(private tareasService: TareasService) {this.
    subscription :Subscription = this.tareasService.tareasSubject.subscribe(tareas => {
  ...
  ngOnDestroy(): void {
   ...
   markTareaAsDone(taskIndex: number): void {
    ...
    //this.tareasService.tareas.splice(taskIndex, 1)
   // this.tareasService.AsDone();
